...
1. `招标要求.md`
2. `customer-needs-analysis.md` ← 【售前新增】
3. `solution.md` ← 【售前新增】
4. `技术方案.md`
5. `商务报价.md`
6. `投标结果.md`
...
#### 1d. customer-needs-analysis.md ← 【售前核心文档】
...
obsidian create path="投标档案/投标-{客户}-{主题}-{日期}/customer-needs-analysis.md" content="..."
obsidian create path="投标档案/投标-{客户}-{主题}-{日期}/solution.md" content="..."
...
1. [[线索-{客户}-{主题}]] — 关联来源线索
2. [[客户档案-{客户}]] — 关联客户档案
3. [[知识库/合同范本/]] — 历史同类项目合同参考

提议 2 — 售前工作流建议：
1. 是否立即录入首次需求对接内容？（更新「customer-needs-analysis.md」）
2. 是否关联下游合作团队？（如需联合投标）
...
读取或创建 `投标档案/投标-{客户}-{主题}-{日期}/presales-material-list.md`：
...
文件路径：`投标档案/投标-{客户}-{主题}-{日期}/需求冻结/requirement-lock-confirmation.md`
...
- [[售前材料/requirement-lock-confirmation-签字版.pdf]]
```
...
```bash
# 更新解决方案状态为"已定稿"
obsidian read path="投标档案/投标-{客户}-{主题}-{日期}/solution.md"
# 追加版本记录：v1 已冻结

# 更新客户需求分析 - 标记需求已冻结
obsidian read path="投标档案/投标-{客户}-{主题}-{日期}/customer-needs-analysis.md"
```
