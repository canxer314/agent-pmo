...
| `/initiate` 从投标创建 | 自动链接来源 `[[售前项目/.../投标结果]]` | bid 参数已提供 |
...
| 客户需求分析 | `客户需求分析` | `售前项目/.../客户需求分析.md` |
| 解决方案 | `解决方案` | `售前项目/.../解决方案.md` |
| 售前材料清单 | `售前材料清单` | `售前项目/.../售前材料清单.md` |
| 技术交流记录 | `技术交流记录-{日期}` | `售前项目/.../技术交流记录/YYYY-MM-DD.md` |
| 需求冻结确认书 | `需求冻结确认书` | `售前项目/.../需求冻结/需求冻结确认书.md` |
