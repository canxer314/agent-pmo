...
| 售前项目 | `售前项目/{客户}-{主题}-{日期}/` | `项目概览.md`（由 `/bid action=new` 创建） | `[[售前项目/{客户}-{主题}-{日期}/00-项目概览]]` |

> **为什么售前项目用 `项目概览.md`？** 与正式项目的 `00-项目章程.md` 对等——售前项目同样需要一个导航枢纽。由 `/bid action=new` 保证始终创建。
...
- `解决方案.md`、`客户需求分析.md`、`项目概览.md`、`招标要求.md`、`技术方案.md`、`商务报价.md`、`投标结果.md`（每个售前项目）
...
| 项目概览（售前） | `00-项目概览` | `售前项目/{客户}-{主题}-{日期}/项目概览.md` |
